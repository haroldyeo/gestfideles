...
//		
		pageMap.put("fn1",new SidebarPage("Utilisateurs","Utilisateurs","/imgs/demo.png","/references/users/usersList.zul"));
		pageMap.put("fn2",new SidebarPage("Nouveau profil","Nouveau profil","/imgs/demo.png","/common/profile.zul"));
